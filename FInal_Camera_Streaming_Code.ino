...
// Declare tcpHandle globally
TaskHandle_t tcpHandle;

// Wi-Fi credentials
const char* ssid = "Paloan's Dining";
const char* password = "level6_f2";
...
void setup() {
  ...
  // Get IP Address
  ip = WiFi.localIP();
  Serial.print("Camera Ready! MJPEG Stream Link: http://");
  Serial.print(ip);
  Serial.println("/");
  ...
  // Display TCP server link
  Serial.print("TCP Server Link: ");
  Serial.print(ip);
